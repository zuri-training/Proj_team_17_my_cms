    ...
    <section className='w-full py-36 xl:px-0 px-5'>
        <div className='flex flex-row justify-between items-start max-w-6xl my-0 mx-auto'>
            <div className='flex flex-col items-start max-w-xl'>
                <h1 className='arima-heading text-5xl mb-2 overflow-hidden font-bold leading-relaxed text-gray-800'>Integration</h1>
                ...
                <Link to='' className='font-semibold'>Link Account →</Link>
            </div>
            <div className='flex'>
