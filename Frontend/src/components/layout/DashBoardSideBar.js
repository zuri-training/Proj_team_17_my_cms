...
const DashBoardSideBar = () => {
  return (
    ...
    <div className=" text-[32px] font-semibold"><h1>Name</h1></div>
        ...
        <div className="pt-10 pb-[60px]">
            {
                DashBoardSideBarData.map((item, index) => {
                    return(
                        <div  key={index}  className="flex pb-2 text-lg  items-center gap-5 justify-start text-center cursor-pointer ">
                            <div className=" my-4 ">
...
<FontAwesomeIcon className="font-3xl" icon={faSignOut}/>
    <h1>Log Out</h1>
    </div>
       </div>
       </div>
